...
import com.protonmail.slobodo.bd2.config.SpringDataConfiguration;
...
public class MLServiceTestCase {
    ...
    public void testCreateUser() throws MLException{
        ...
        User u = this.service.createUser("federico.orlando@mail.ar", "Federico Orlando", "pas$w0rd", dob);
        assertNotNull (u.getId());
        assertEquals("Federico Orlando",u.getFullname());
        Optional<User> us = this.service.getUserByEmail("federico.orlando@mail.ar");
        if (!us.isPresent()) {
        ...
        MLException ex = assertThrows(MLException.class, () -> this.service.createUser("federico.orlando@mail.ar", "Federico Orlando", "pas$w0rd", dob));
